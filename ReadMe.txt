1. 	Go f�r Windows herunterladen (MSI Installer)
	https://golang.org/dl/

2. 	�ffne den MSI Installer und befolge die Installationsanleitung
...
*	Falls dies nicht der fall ist muss C:\Go\bin der PATH Environment hinzugef�gt werden.
